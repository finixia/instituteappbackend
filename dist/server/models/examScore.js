...
exports.ExamScoreModel = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const ExamScoreSchema = new mongoose_1.Schema({
    ...
    updatedByUserId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true }
}, { timestamps: true });
ExamScoreSchema.index({ examId: 1, studentId: 1 }, { unique: true });
exports.ExamScoreModel = mongoose_1.default.model("ExamScore", ExamScoreSchema);
